...
public class RRintegrationTest {
    ...
    BankTeller bankTeller=new BankTeller("bankTeller","1234");
        ...
        assertEquals(bankTeller.getHistory(account1),"nullDeposit: 0.01, Withdraw: 20.0, ");
        ...
        assertEquals(bankTeller.getHistory(account1),"nullDeposit: 0.01, Withdraw: 20.0, Deposit: 100.0, ");
    }
